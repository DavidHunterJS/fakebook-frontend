...
const PostForm: React.FC<PostFormProps> = ({
  ...
  const getValidationSchema = () => {
    // This Yup schema already contains the logic you need.
    // It checks if 'hasImage' is false, and if so, it makes the 'text' field required.
    return Yup.object({
      ...
      <Box component="form" onSubmit={formik.handleSubmit}>
        <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 2 }}>
          ...
          <TextField
            ...
            // ✅ These props connect Formik's validation to the UI.
            // When the 'text' field is invalid, the error message from Yup will be displayed.
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 1 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Button
              ...
              color="primary"
              type="submit"
              // ✅ IMPROVEMENT: This uses Formik's state to disable the button if the form is invalid
              // or if it's in edit mode and no changes have been made ('!formik.dirty').
